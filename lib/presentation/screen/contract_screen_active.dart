...
import 'package:mft_customer_side/presentation/widget/contract/cancel_contract_dialog.dart';

class ContractScreenActive extends StatefulWidget {
  @override
  _ContractScreenActiveState createState() => _ContractScreenActiveState();
}

class _ContractScreenActiveState extends BaseState<ContractScreenActive> {
      ...
      child: Column(
        ...
        children: [
          ...
          BlocBuilder<ContractBloc, ContractState>(
            builder: (builderContext, state) {
              if (state is ContractLoaded) {
                ...
                cancelContractNumber = state.contract.contractNumber;
          ...
          BlocBuilder<ContractBloc, ContractState>(
            builder: (builderContext, state) {
              if (state is ContractLoaded) {
                contractPrice = state.contract.contractPrice;
                ...
                return Column(
                  children: [
                    ...
                    _contractRow(
                        title: "Giá trị hiện tại của hợp đồng là:",
                        content:
                            "${moneyFormat.format(state.contract.contractPrice)} VND"),
          ...
          Padding(
            ...
            child: BorderButton(
              title: translator.text("cancel_contract"),
              color: _isAgreed ? Colors.red : Colors.grey,
              function: _isAgreed
                  ? () {
                      showDialog(
                        context: context,
                        builder: (_) => MultiBlocProvider(
                          ...
                          child: CancelContractDialog(
                            user: user,
                            contractPrice: contractPrice,
                            contractID: contractID,
                            farmerUsername: farmerUsername,
                            contractNumber: cancelContractNumber,
                          ),
                        ),
                      );
                    }
